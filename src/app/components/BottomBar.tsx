...
const bottomItems = [ 
    ...
    { name: "My Saved", path: "/pages/saved", svg: <svg width="20" height="20" viewBox="0 0 18 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    { name: "Chat", path: "/pages/chat", svg: <svg width="20" height="20" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd" d="M64 0C28.7 0 0 28.7 0 64L0 352c0 35.3 28.7 64 64 64l96 0 0 80c0 6.1 3.4 11.6 8.8 14.3s11.9 2.1 16.8-1.5L309.3 416 448 416c35.3 0 64-28.7 64-64l0-288c0-35.3-28.7-64-64-64L64 0z" fill="#796FAB"/>
    </svg> },
];

const moreItems = [
    { name: "Support", path: "/pages/support", svg: <svg width="20" height="20" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='z-[100] fixed bottom-0 left-0 px-5 lg:hidden flex items-center justify-between w-full bg-[#EFF6F8] shadow-2xl shadow-[#796FAB] drop-shadow-2xl h-[60px]'>
            ...
            >
                <summary className='list-none flex flex-col gap-1 items-center justify-center mt-1'>
                    ...
                    <small className={openDetail ? "block text-white" : "hidden text-purple"}>More</small>
                </summary>
