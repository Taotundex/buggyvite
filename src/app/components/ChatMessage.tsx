  ...
  return (
    <div className="">
        <div className={`chat ${isOwnMessage ? "chat-end" : isSystemMessage ? "chat-end" : "chat-start"}`}>
            ...
            <div className={`chat-bubble -z-[1] rounded-[10px] h-full min-h-full md:text-base text-sm ${isSystemMessage ? "bg-[#D9D9D9] text-[#282828] rounded-[0px]" : isOwnMessage ? "bg-[#796FAB] text-white" : "bg-[#D9D9D9] text-[#282828]"}`}>{message}</div>
