  ...
  return (
    <div className='h-screen grid lg:grid-cols-6 grid-cols-5 overflow-hidden'>
        ...
        <div className="main-body col-span-5 h-screen overflow-y-scroll">
            ...
            <div className="h-screen flex flex-col md:flex-row md:px-10 px-5">
                <div className={`w-full md:w-1/3 border-r border-black ${selectedChat ? "hidden md:block" : "block"}`}>
                    <ClientChatList />
                    <ClientChatList />
                    <ClientChatList />
                    <ClientChatList />
                ...
                <div className={`w-full md:w-2/3 h-4/5 border-4 border-red-600 ${selectedChat ? "block" : "hidden md:block" }`}>
                    {/* <div className="h-full">
                        {
                            joined 
                            ? 
