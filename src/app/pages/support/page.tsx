        ...
        <div className="container py-[50px] flex flex-col gap-[50px]">
            ...
            <div className="grid md:grid-cols-5 grid-cols-1 gap-10">
                ...
                <div className="text-[#282828] md:col-span-3 col-span-1 flex flex-col gap-3">
                    ...
                    <label htmlFor="search" className='input input-bordered bg-transparent w-full flex flex-row-reverse items-center gap-1 border border-[#796FAB] px-3 rounded-[10px] h-[50px] mr-5 md:w-[500px]'>
            ...
            <div className="grid md:grid-cols-3 grid-cols-2 md:gap-5 gap-3">
                <div className="flex flex-col items-center md:gap-3 gap-1 rounded-[10px] bg-[#796FAB] text-center md:p-10 p-3 text-[#EFF6F8]">
