  ...
  return (
    <div className='h-screen grid md:grid-cols-6 grid-cols-5 overflow-hidden'>
        ...
        <div className="main-body col-span-5 h-screen overflow-y-scroll md:pb-0 pb-[50px]">
            ...
            <div className="md:h-full h-auto md:p-10 p-5 grid md:grid-cols-2 grid-cols-1 gap-10 items-center">
                <div className="flex flex-col gap-3">
                    <h5 className='text-[#796FAB] text-xl font-extrabold'>How it Started</h5>
                    <h2 className='italic font-extrabold text-[#282828] md:text-[50px] text-4xl md:leading-[50px] leading-[36px]'>Empowering You to Work, Sell and Earn Seamlessly</h2>
                ...
                <Image src="/images/young people working at the desk.png" width={460} height={460} alt='young people working at the desk' />
            </div>
        </div>
        <BottomBar />
    </div>
